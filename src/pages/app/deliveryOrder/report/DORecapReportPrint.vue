<script setup>
import {useDORecapReportPrintStore} from "stores/report/do/DORecapReportPrintStore";
...
const print = useDORecapReportPrintStore()
const {form, table} = useDORecapReportPrintStore()
const {getAllData: data, getSummaries: summaries, form: refForm} = storeToRefs(useDORecapReportPrintStore())
  ...
  <q-page class="print:tw-mt-0" padding>
    ...
    <table class="tw-border-collapse tw-border tw-border-slate-900 tw-w-full">
      ...
      <tr>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-left">Total DO</th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Harga Pabrik (Avg) (Rp/kg)</th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Tonase</th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Margin (Avg)</th>
      ...
      <tr v-for="(detail, i) in table.data" :key="i">
        ...
        <td class="tw-border tw-border-slate-900 tw-py-1 tw-px-2">{{ detail.count }} DO</td>
