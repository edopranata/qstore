  ...
  <q-page padding>
    ...
    <q-card>
      <q-table
        ...
        :rows="table.data ?? []"
        :selection="can('app.perkebunan.lahan.[hapusDataLahan]') ? 'multiple' :'single'"
        binary-state-sort
        bordered
        row-key="id"
        @request="onRequest"
      >
        <template v-slot:top>
          <q-toolbar class="text-primary">
            ...
            <div v-if="can('app.perkebunan.lahan.[simpanDataLahan,updateDataLahan,hapusDataLahan]')"
                 class="tw-space-x-2">
              <q-btn
                v-if="can('app.perkebunan.lahan.hapusDataLahan')"
                :dense="$q.screen.lt.md"
              ...
              <q-btn
                v-if="can('app.perkebunan.lahan.updateDataLahan')"
                :dense="$q.screen.lt.md"
              ...
              <q-btn
                v-if="can('app.perkebunan.lahan.simpanDataLahan')"
                :dense="$q.screen.lt.md"
