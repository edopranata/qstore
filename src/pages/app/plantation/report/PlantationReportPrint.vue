<script setup>
import {usePlantationRecapReportPrintStore} from "stores/report/plantation/plantationReportPrintStore";
...
const print = usePlantationRecapReportPrintStore()
const {form, table} = usePlantationRecapReportPrintStore()
const {getAllData: data, getSummaries: summaries, form: refForm} = storeToRefs(usePlantationRecapReportPrintStore())
  ...
  <q-page class="print:tw-mt-0" padding>
    ...
    <div class="tw-grid tw-grid-cols-10 tw-font-sans tw-font-bold">
      <div class="tw-col-span-10 tw-flex justify-start tw-space-x-2">
        <div>Pendapatan Hasil Kebun</div>
    ...
    <table class="tw-border-collapse tw-border tw-border-slate-900 tw-w-full">
      ...
      <tr>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-left">Mobil / Supir</th>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Biaya Trip</th>
