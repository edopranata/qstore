        ...
        >
          <template v-slot:top>
            <div class="tw-flex tw-space-x-2 tw-w-full">
              <q-btn
                v-if="can('app.mobil.pinjamanBaru.[index,simpanPinjamanBaru]')"
                :dense="$q.screen.lt.lg"
                :loading="table.loading"
                :to="{name: 'app.mobil.pinjamanBaru.index'}"
                color="secondary"
                glossy
                icon="add_circle"
                label="Pinjaman Baru"
              ...
              <q-space></q-space>
              <q-btn
                v-if="can('app.mobil.pinjamanBaru.simpanPinjamanBaru')"
                :dense="$q.screen.lt.lg"
