...
<template>
  <q-page class="tw-space-y-4" padding>
    <q-card v-if="can('app.transaction.hasilKebun.[createHasilKebun]')" bordered>
      <q-form
        class="tw-w-full"
        @reset="onReset"
        @submit="onSubmit"
      >
        <q-card-section>
          <div class="tw-flex tw-flex-col md:tw-grid md:tw-gap-4 md:tw-grid-cols-2">
            ...
            <div class="tw-grid tw-gap-2 tw-content-start">
              <div class="tw-font-bold">Lahan kebun yang panen</div>
              <q-markup-table
                bordered
                class="tw-w-full tw-col-span-2"
                dense
              ...
              <!--                <thead>-->
              <!--                <tr>-->
              <!--                  <th class="text-left" style="width: 260px">Cluster Kebun</th>-->
              <!--                  <th class="text-left">Kebun</th>-->
              <!--                </tr>-->
              <!--                </thead>-->
              <!--                <tbody>-->
              <!--                <tr v-for="(area, a) in areas" :key="a">-->
              <!--                  <td class="text-left tw-align-text-top" style="max-width: 120px; min-width: 60px">{{ area.name }}</td>-->
              <!--                  <td class="text-left">-->
              <!--                    <div class="tw-grid lg:tw-grid-cols-2 tw-gap-1">-->
              <!--                    <q-checkbox-->
              <!--                      v-for="(land, i) in area.lands"-->
              <!--                      :key="i"-->
              <!--                      v-model="plantation.selected_lands"-->
              <!--                      :dense="$q.screen.lt.md"-->
              <!--                      :label="land.name"-->
