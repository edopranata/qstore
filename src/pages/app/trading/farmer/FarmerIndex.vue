...
import DialogDelete from "pages/app/trading/farmer/dialog/DialogDelete.vue";
import DialogCreate from "pages/app/trading/farmer/dialog/DialogCreate.vue";
import DialogEdit from "pages/app/trading/farmer/dialog/DialogEdit.vue";
  ...
  <q-page padding>
    ...
    <q-card>
      <q-table
        ...
        :rows="table.data ?? []"
        :selection="can('app.jualBeliSawit.dataPetani.[hapusDataPetani]') ? 'multiple' :'single'"
        binary-state-sort
        bordered
        row-key="id"
        @request="onRequest"
      >
        <template v-slot:top>
          <q-toolbar class="text-primary">
            ...
            <div v-if="can('app.jualBeliSawit.dataPetani.[simpanDataPetani,updateDataPetani,hapusDataPetani]')"
                 class="tw-space-x-2">
              <q-btn
                v-if="can('app.jualBeliSawit.dataPetani.hapusDataPetani')"
              ...
              <q-btn
                v-if="can('app.jualBeliSawit.dataPetani.updateDataPetani')"
              ...
              <q-btn
                v-if="can('app.jualBeliSawit.dataPetani.simpanDataPetani')"
