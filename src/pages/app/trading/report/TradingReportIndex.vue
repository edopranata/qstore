...
import {useTradingReportStore} from "stores/report/trading/TradingReportStore";

const {can} = useAuthStore()
const {path} = useRoute()
const report = useTradingReportStore()
const {table, form} = useTradingReportStore()
const {getReportOptions: options, getTypeChange, errors} = storeToRefs(useTradingReportStore())
                ...
                <q-card-actions class="no-padding tw-mt-4">
                  <div class="md:tw-col-span-4 tw-col-span-2 tw-space-x-2">
                    ...
                    <q-btn
                      ...
                      :loading="table.loading"
                      :to="{name: 'app.jualBeliSawit.laporan.printJualBeliSawit', query: {type: form.type, period_end: form.period_end, period_start: form.period_start }}"
                      color="deep-orange"
                ...
                <q-card-actions class="no-padding tw-mt-4">
                  <div class="md:tw-col-span-4 tw-col-span-2 tw-space-x-2">
                    <q-btn v-if="can('app.jualBeliSawit.laporan.jualBeliSawit')" :disable="table.loading"
                           ...
                           label="Lihat laporan"
                           type="submit"/>
                    <q-btn v-if="can('app.jualBeliSawit.laporan.printJualBeliSawit')"
                           :disable="table.loading || !form.type || String(form.monthly).length !== 7"
                           :loading="table.loading"
                           :to="{name: 'app.jualBeliSawit.laporan.printJualBeliSawit', query: {type: form.type, monthly: form.monthly}}"
                           color="deep-orange"
                           glossy icon="print" label="Print laporan"/>
                  </div>
                </q-card-actions>
                ...
                <q-card-actions class="no-padding tw-mt-4">
                  <div class="md:tw-col-span-4 tw-col-span-2 tw-space-x-2">
                    ...
                    <q-btn v-if="can('app.jualBeliSawit.laporan.printJualBeliSawit')"
                           ...
                           :loading="table.loading"
                           :to="{name: 'app.jualBeliSawit.laporan.printJualBeliSawit', query: {type: form.type, annual: form.annual}}"
                           color="deep-orange"
                           glossy icon="print" label="Print laporan"/>
                  </div>
                </q-card-actions>
