  ...
  <q-page class="print:tw-mt-0" padding>
    ...
    <table class="tw-border-collapse tw-border tw-border-slate-900 tw-w-full tw-text-xs tw-font-sans">
      ...
      <tr>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Timbangan Lap (kg)</th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Harga Lap (Avg) (Rp/kg)</th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Hasil Petani (Rp)</th>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">Margin (Avg) (Rp)</th>
        ...
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">
          {{
            new Intl.NumberFormat('id-ID', {
              style: 'unit',
              unit: 'kilogram'
            }).format(summaries.customer_weight)
          }}
        </th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">
          {{
            new Intl.NumberFormat('id-ID', {
              ...
              currency: 'IDR',
              maximumFractionDigits: 2
            }).format(summaries.customer_average)
          }}
        </th>
        <th class="tw-border tw-border-gray-900 tw-py-1 tw-px-2 text-right">
          {{
