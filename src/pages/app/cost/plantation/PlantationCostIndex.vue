...
const {errors, getSelectedLand, getSelected: selected, form: formField,} = storeToRefs(useLandCostStore())
const $q = useQuasar()
const tableRef = ref()
...
watch(getSelectedLand, (selectedLand) => {
    ...
    <q-card bordered>
      ...
      >
        ...
        <q-card-section class="tw-flex justify-between tw-space-x-2">
          <q-btn
            v-if="can('app.biaya.biayaKebun.simpanBiayaKebun')"
          ...
          <q-space></q-space>
          <q-btn
            v-if="can('app.biaya.biayaKebun.hapusBiayaKebun')"
            :dense="$q.screen.lt.lg"
          ...
          <q-btn
            v-if="can('app.biaya.biayaKebun.ubahBiayaKebun')"
            :dense="$q.screen.lt.lg"
            :disable="selected.length !== 1"
