...
export const useInvoiceFarmerDataStore = defineStore('invoiceFarmer', {
  state: () => ({
    table: {
      pagination: {
        sortBy: '',
      ...
      headers: reactive([
        ...
        {name: "customer_name", label: "Nama Petani", field: "customer_name", sortable: false, align: 'left'},
        ...
        {name: "detail_trades", label: "Diterima Petani", field: "detail_trades", sortable: false, align: 'right'},
        {name: "loan_detail", label: "Pinjaman Petani", field: "loan_detail", sortable: false, align: 'right'},
